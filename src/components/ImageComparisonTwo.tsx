...
const ImageComparisonTwo = () => {
  ...
  return (
    <div className="relative w-full h-96">
      <img src="to/2befor.jpg" alt="After" className="absolute rounded-lg top-0 left-0 w-full h-full object-cover" />
      <img src="to/2.jpg" alt="Before" ref={beforeRef} className="absolute rounded-lg top-0 left-0 w-full h-full object-cover" />
      <input 
        type="range" 
        min="0" 
        max="100" 
